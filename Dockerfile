...
# Run with minimal workers - exec form with shell for reliable $PORT expansion
CMD ["sh", "-c", "exec uvicorn app.main:app --host 0.0.0.0 --port ${PORT:-10000} --workers 1 --limit-max-requests 1000"]
